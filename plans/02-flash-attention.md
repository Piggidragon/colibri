...
`V4_FLASH=0` und Müll-Eingabe ab. Das Tiny-Orakel ist mit `V4_FLASH=1` und `0`
einschließlich Prefix-Reuse token-identisch. Dabei wurde ein bereits in Phase 01
angelegter Widerspruch repariert: Der 520-Token-CTX-Test brauchte eine
768-Token-Fixture, deren `max_position_embeddings` noch 128 war; die
YARN-Originalgrenze bleibt unverändert 128.
...
diesen Attention-Anteil. Der 167-GB-Checkpoint und die Zielmaschine waren in der
Entwicklungsumgebung nicht vorhanden; das ist daher eine isolierte
Kernel-/Staging-Messung, keine End-to-End-tok/s-Zahl.
